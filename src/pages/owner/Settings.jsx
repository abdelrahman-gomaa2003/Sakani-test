...
function OwnerSettings() {
  ...
  return (
    <div className="d-flex flex-column gap-4 owner-stagger" style={{ maxWidth: 740, margin: "0 auto" }}>
      <div className="owner-section" style={{ animationDelay: "0.04s" }}>
      ...
      <div className="owner-section-card p-4 owner-section" style={{ animationDelay: "0.08s" }}>
        ...
        <div className="d-flex justify-content-between align-items-center py-3">
          <div>
            <p className="fw-bold mb-0" style={{ fontSize: "1rem", color: "var(--on-surface, #1A1D23)" }}>إشعارات الطلبات الجديدة</p>
            <p className="mb-0" style={{ fontSize: "0.9rem", color: "var(--on-surface-variant, #5A6370)" }}>تنبيه فوري عند وجود طلب حجز جديد</p>
          </div>
          <div className="form-check form-switch mb-0">
            <input className="form-check-input" type="checkbox" checked={notifications} onChange={() => setNotifications(!notifications)} style={{ cursor: "pointer" }} />
          </div>
      ...
      {/* Security & Password */}
      <div className="owner-section-card overflow-hidden owner-section" style={{ animationDelay: "0.12s", border: securityOpen ? "2px solid var(--primary)" : "2px solid transparent", transition: "border-color 0.3s" }}>
        {/* Header - clickable */}
        <button
        ...
        >
          <form onSubmit={handleChangePassword} className="px-4 pb-4 d-flex flex-column gap-4">
            ...
            {confirmPw && confirmPw !== newPw && (
              <div className="d-flex align-items-center gap-2 p-3 rounded-3" style={{ background: "rgba(196,91,74,0.08)", animation: "ownerFadeIn 0.3s ease" }}>
            ...
            <button
              type="submit"
              className="btn w-100 py-3 fw-bold d-flex align-items-center justify-content-center gap-2 owner-btn-lift"
      ...
      {/* Danger Zone */}
      <div className="owner-section-card p-4 owner-section" style={{ animationDelay: "0.16s", border: "1px solid rgba(196,91,74,0.2)" }}>
        ...
        <div className="d-flex justify-content-between align-items-center">
          ...
          <button className="btn btn-outline-danger btn-sm owner-btn-lift" style={{ fontSize: "0.9rem" }} onClick={() => setConfirmDelete(true)}>حذف الحساب</button>
        </div>
      </div>

      {/* Logout */}
      <button
        className="btn d-flex align-items-center justify-content-center gap-2 py-3 fw-bold rounded-3 owner-btn-lift owner-section"
        style={{ border: "2px solid var(--primary)", color: "var(--primary)", fontSize: "1rem", animationDelay: "0.2s" }}
